...
public class TestCaseBase {
	...
	public void setUpBrowser(@Optional("firefox")String browserFlagO,@Optional("false")String runningOnGrid,@Optional("0")String hubHost,@Optional("0")String hubPort) throws Exception {
