//this is copied from testNG source file and do a bit modification, you could skip most of details here
...
*/
public class EmailableSummaryReporter implements IReporter {
...
*/
  ...
  public void generateSuiteSummaryReport(List<ISuite> suites) {
    ...
    for (ISuite suite : suites) {
        if ((suites.size() > 1)&& suite.getResults().size()==0) {
