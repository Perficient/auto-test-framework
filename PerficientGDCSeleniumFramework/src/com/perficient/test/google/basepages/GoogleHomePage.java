...
import com.perficient.test.util.SystemUtil;
...
public class GoogleHomePage extends Page {
	...
	@FindBy(id = "gbi4")
	public WebElement signedInUser;//ie,ff
	...
	public GoogleHomePage logout() throws InterruptedException {
		...
		if(browserFlag.equals("chrome")){
			//the chrome has a special web element for the signed in user link
			signedInUser=signedInUserChrome;
		}
